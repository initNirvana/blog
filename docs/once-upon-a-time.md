...
- absolute address 「 순」 절대 번지 : 절대 번지는 번지가 주소로 바뀌어 현재까지 이어졌다. <br/>
- accumulator 「 순」 누산기(累算器) : 누산기가 번역 용어로서, 전달력에 있어서 적절한가? 라는 의문을 가진다면 부족할 수도 있다. 한자용어를 대체할 수 있는 단어가 마땅히 생각이 나지 않는다.
